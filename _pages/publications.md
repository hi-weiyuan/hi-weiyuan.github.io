...
新闻
======
* (26/01/2022) 我的一篇论文 "Interaction-level Membership Inference Attack Against Federated Recommender Systems" 被录用于计算机综合领域国际顶会 The Web Conference (WWW) 2023 (CCF A, CORE A*).
* (19/10/2022) 我的一篇论文 "Federated Unlearning for On-Device Recommendation" 被录用于数据挖掘领域国际顶会 Web Search and Data Mining (WSDM) 2023 (CCF B, CORE A).
